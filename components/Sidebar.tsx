...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 h-full w-[300px] bg-gradient-jet p-6 z-50 overflow-y-auto transition-transform duration-300 ${
      ...
      <div className="border-t border-jet pt-6 mt-6">
          <ul className="space-y-4">
            <li className="flex items-start gap-4">
              ...
              <div>
                <p className="text-xs text-light-gray-70 mb-1">Email</p>
                <a
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                <p className="text-xs text-light-gray-70 mb-1">Location</p>
                <address className="text-sm text-light-gray not-italic">
          ...
          <div className="border-t border-jet mt-6 pt-6">
            <ul className="flex gap-4 justify-center">
              <li>
                <a
                  href={personalInfo.social.facebook}
                  className="w-10 h-10 rounded-lg bg-gradient-onyx flex items-center justify-center text-light-gray hover:text-vegas-gold transition-colors"
                >
