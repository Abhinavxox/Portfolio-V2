...
const Navbar = () => {
  return (
    <div className="md:pt-20 pt-5 md:px-40 px-10 bg-[#2E2E35]">
        ...
        <div className="flex justify-between items-center">
          ...
          <ul className="xl:flex justify-between items-center float-right w-96 text-md hidden font-semibold">
            ...
            <div className="flex items-center justify-between">
              <a
                className="pb-0 px-2 before:-bottom-2"
                href="https://github.com/Abhinavxox"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
              ...
              <a
                className="pb-0 px-2 before:-bottom-2"
                href="https://twitter.com/MeroNaamAbhinav"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
